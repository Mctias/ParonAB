...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_rxjs_add_operator_map__ = __webpack_require__(168);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_rxjs_add_operator_map___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_rxjs_add_operator_map__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return LagerService; });
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var LagerService = (function () {
    function LagerService(http) {
        this.http = http;
    }
    LagerService.prototype.createLager = function (lager) {
        var headers = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["Headers"]();
        headers.append('Content-Type', 'application/json');
        return this.http.post('http://localhost:3000/lagers/addLager', JSON.stringify(lager), { headers: headers })
            .map(function (res) { return res.json(); }); //(endpoint, object, headers).map(response as json)
    };
    LagerService.prototype.updateWarehouse = function (data) {
        var headers = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["Headers"]();
        headers.append('Content-Type', 'application/json');
        return this.http.put('http://localhost:3000/lagers/addDelivery', JSON.stringify(data), { headers: headers })
            .map(function (res) { return res.json(); }); //(endpoint, object, headers).map(response as json)
    };
    LagerService.prototype.getLager = function () {
        return this.http.get('http://localhost:3000/lagers/lager').map(function (res) { return res.json(); });
    };
    LagerService = __decorate([
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Injectable"])(), 
        __metadata('design:paramtypes', [(typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__angular_http__["Http"] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_1__angular_http__["Http"]) === 'function' && _a) || Object])
    ], LagerService);
    return LagerService;
...
//# sourceMappingURL=C:/Users/matte/Documents/ParonAB/angular-src/src/lager.service.js.map
...
var ProductService = (function () {
    ...
    ProductService.prototype.getProducts = function () {
        return this.http.get('http://localhost:3000/products/products').map(function (res) { return res.json(); });
    };
...
//# sourceMappingURL=C:/Users/matte/Documents/ParonAB/angular-src/src/product.service.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__components_dashboard_dashboard_component__ = __webpack_require__(519);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__components_leveranser_leveranser_component__ = __webpack_require__(520);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__components_create_lager_create_lager_component__ = __webpack_require__(518);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__services_validate_service__ = __webpack_require__(527);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__services_auth_service__ = __webpack_require__(107);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__services_product_service__ = __webpack_require__(341);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__services_lager_service__ = __webpack_require__(108);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__services_delivery_service__ = __webpack_require__(225);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__guards_auth_guard__ = __webpack_require__(526);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__components_new_delivery_new_delivery_component__ = __webpack_require__(523);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__components_not_found_not_found_component__ = __webpack_require__(524);
...
var appRoutes = [
    ...
    { path: 'leveranser', component: __WEBPACK_IMPORTED_MODULE_10__components_leveranser_leveranser_component__["a" /* LeveranserComponent */], canActivate: [__WEBPACK_IMPORTED_MODULE_17__guards_auth_guard__["a" /* AuthGuard */]] },
    { path: 'createLager', component: __WEBPACK_IMPORTED_MODULE_11__components_create_lager_create_lager_component__["a" /* CreateLagerComponent */], canActivate: [__WEBPACK_IMPORTED_MODULE_17__guards_auth_guard__["a" /* AuthGuard */]] },
    { path: 'createDelivery', component: __WEBPACK_IMPORTED_MODULE_18__components_new_delivery_new_delivery_component__["a" /* NewDeliveryComponent */], canActivate: [__WEBPACK_IMPORTED_MODULE_17__guards_auth_guard__["a" /* AuthGuard */]] },
    ...
    AppModule = __decorate([
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__angular_core__["NgModule"])({
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_10__components_leveranser_leveranser_component__["a" /* LeveranserComponent */],
                __WEBPACK_IMPORTED_MODULE_11__components_create_lager_create_lager_component__["a" /* CreateLagerComponent */],
                __WEBPACK_IMPORTED_MODULE_18__components_new_delivery_new_delivery_component__["a" /* NewDeliveryComponent */],
            ...
            providers: [__WEBPACK_IMPORTED_MODULE_12__services_validate_service__["a" /* ValidateService */], __WEBPACK_IMPORTED_MODULE_13__services_auth_service__["a" /* AuthService */], __WEBPACK_IMPORTED_MODULE_14__services_product_service__["a" /* ProductService */], __WEBPACK_IMPORTED_MODULE_15__services_lager_service__["a" /* LagerService */], __WEBPACK_IMPORTED_MODULE_16__services_delivery_service__["a" /* DeliveryService */], __WEBPACK_IMPORTED_MODULE_17__guards_auth_guard__["a" /* AuthGuard */]],
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__services_lager_service__ = __webpack_require__(108);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__angular_router__ = __webpack_require__(64);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return CreateLagerComponent; });
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var CreateLagerComponent = (function () {
    function CreateLagerComponent(lagerService, router) {
        this.lagerService = lagerService;
        this.router = router;
    }
    CreateLagerComponent.prototype.ngOnInit = function () {
    };
    CreateLagerComponent.prototype.onCreateLager = function () {
        var _this = this;
        var lager = {
            name: this.name
        };
        this.lagerService.createLager(lager).subscribe(function (data) {
            if (data.success) {
    ...
    CreateLagerComponent = __decorate([
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'app-create-lager',
            template: __webpack_require__(695),
            styles: [__webpack_require__(686)]
        }), 
        __metadata('design:paramtypes', [(typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__services_lager_service__["a" /* LagerService */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_1__services_lager_service__["a" /* LagerService */]) === 'function' && _a) || Object, (typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_2__angular_router__["b" /* Router */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_2__angular_router__["b" /* Router */]) === 'function' && _b) || Object])
    ], CreateLagerComponent);
    return CreateLagerComponent;
    var _a, _b;
}());
//# sourceMappingURL=C:/Users/matte/Documents/ParonAB/angular-src/src/create-lager.component.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__services_lager_service__ = __webpack_require__(108);
...
var DashboardComponent = (function () {
    function DashboardComponent(productService, lagerService) {
        this.productService = productService;
        this.lagerService = lagerService;
    }
    DashboardComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.lagerService.getLager().subscribe(function (lager) {
            _this.lagers = lager;
            console.log(lager);
        }, function (err) {
            console.log(err);
    ...
    DashboardComponent = __decorate([
        ...
        __metadata('design:paramtypes', [(typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__services_product_service__["a" /* ProductService */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_1__services_product_service__["a" /* ProductService */]) === 'function' && _a) || Object, (typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_2__services_lager_service__["a" /* LagerService */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_2__services_lager_service__["a" /* LagerService */]) === 'function' && _b) || Object])
    ], DashboardComponent);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__services_lager_service__ = __webpack_require__(108);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__services_delivery_service__ = __webpack_require__(225);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__angular_router__ = __webpack_require__(64);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return LeveranserComponent; });
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var LeveranserComponent = (function () {
    function LeveranserComponent(lagerService, deliveryService, router) {
        this.lagerService = lagerService;
        this.deliveryService = deliveryService;
        this.router = router;
    }
    LeveranserComponent.prototype.ngOnInit = function () {
        var _this = this;
    ...
    LeveranserComponent.prototype.isPositive = function (delivery) {
        if (delivery.noItems > 0)
            return true;
        return false;
    };
    LeveranserComponent.prototype.onCreateNewDelivery = function () {
        this.router.navigate(['/createDelivery']);
    };
    LeveranserComponent = __decorate([
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'app-leveranser',
            template: __webpack_require__(697),
            styles: [__webpack_require__(688)]
        }), 
        __metadata('design:paramtypes', [(typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__services_lager_service__["a" /* LagerService */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_1__services_lager_service__["a" /* LagerService */]) === 'function' && _a) || Object, (typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_2__services_delivery_service__["a" /* DeliveryService */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_2__services_delivery_service__["a" /* DeliveryService */]) === 'function' && _b) || Object, (typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_3__angular_router__["b" /* Router */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_3__angular_router__["b" /* Router */]) === 'function' && _c) || Object])
    ], LeveranserComponent);
    return LeveranserComponent;
    var _a, _b, _c;
}());
//# sourceMappingURL=C:/Users/matte/Documents/ParonAB/angular-src/src/leveranser.component.js.map
...
var NewDeliveryComponent = (function () {
    function NewDeliveryComponent(lagerService, deliveryService, router) {
        this.lagerService = lagerService;
        this.deliveryService = deliveryService;
        this.router = router;
    }
    ...
    NewDeliveryComponent.prototype.onAddDelivery = function () {
        ...
        this.lagerService.updateWarehouse(delivery).subscribe(function (data) {
            if (data.success) {
...
module.exports = "<br>\n<h1>Warehouse sock</h1>\n<table class=\"table table-striped\">\n  <thead>\n    <tr>\n      <th scope=\"col\">Warehouse</th>\n      <th scope=\"col\">jPlatta</th>\n      <th scope=\"col\">jTelefon</th>\n      <th scope=\"col\">Päronklocka</th>\n    </tr>\n  </thead>\n  <tbody>\n    <tr *ngFor =\"let lager of lagers\">\n      <th scope=\"col\">{{lager.name}}</th>\n      <td>{{lager.products.jPlatta.noItems}}</td>\n      <td>{{lager.products.jTelefon.noItems}}</td>\n      <td>{{lager.products.Paronklocka.noItems}}</td>\n    </tr>\n  </tbody>\n</table>"
